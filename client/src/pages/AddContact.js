  ...
  return (
    <form>
      ...
      <div className="pl-6 pb-6">
        <button type="button" onClick={onSubmit} className="focus:outline-none text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700">Add Contact</button>
        <Link to="/contacts">
